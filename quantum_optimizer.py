...
def run_full_comparison(df, plant=None, material_number=None, max_batch_size=4, reps=1, maxiter=15, random_state=None):
    """
...
def solve_qaoa(problem, reps=1, maxiter=15):
    """
